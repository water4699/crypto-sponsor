...
var __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$ox$2f$node_modules$2f40$noble$2f$curves$2f$esm$2f$p256$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/frontend/node_modules/ox/node_modules/@noble/curves/esm/p256.js [app-client] (ecmascript)");
...
;
;
const noble = __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$ox$2f$node_modules$2f40$noble$2f$curves$2f$esm$2f$p256$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["secp256r1"];
...
function getPublicKey(options) {
    const { privateKey } = options;
    const point = __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$ox$2f$node_modules$2f40$noble$2f$curves$2f$esm$2f$p256$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["secp256r1"].ProjectivePoint.fromPrivateKey(typeof privateKey === 'string' ? privateKey.slice(2) : __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$ox$2f$_esm$2f$core$2f$Hex$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["fromBytes"](privateKey).slice(2));
...
function getSharedSecret(options) {
    ...
    const point = __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$ox$2f$node_modules$2f40$noble$2f$curves$2f$esm$2f$p256$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["secp256r1"].ProjectivePoint.fromHex(__TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$ox$2f$_esm$2f$core$2f$PublicKey$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toHex"](publicKey).slice(2));
    ...
    const sharedPoint = point.multiply(__TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$ox$2f$node_modules$2f40$noble$2f$curves$2f$esm$2f$p256$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["secp256r1"].utils.normPrivateKeyToScalar(privateKeyHex));
...
function randomPrivateKey() {
    let options = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {};
    const { as = 'Hex' } = options;
    const bytes = __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$ox$2f$node_modules$2f40$noble$2f$curves$2f$esm$2f$p256$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["secp256r1"].utils.randomPrivateKey();
...
function recoverPublicKey(options) {
    const { payload, signature } = options;
    const { r, s, yParity } = signature;
    const signature_ = new __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$ox$2f$node_modules$2f40$noble$2f$curves$2f$esm$2f$p256$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["secp256r1"].Signature(BigInt(r), BigInt(s)).addRecoveryBit(yParity);
...
function verify(options) {
    const { hash, payload, publicKey, signature } = options;
    return __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$ox$2f$node_modules$2f40$noble$2f$curves$2f$esm$2f$p256$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["secp256r1"].verify(signature, payload instanceof Uint8Array ? payload : __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$ox$2f$_esm$2f$core$2f$Bytes$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["fromHex"](payload), __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$ox$2f$_esm$2f$core$2f$PublicKey$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toHex"](publicKey).substring(2), ...hash ? [
        {
            prehash: true,
            lowS: true
        }
...
function parseAsn1Signature(bytes) {
    ...
    const r_end = r_start + 32;
    const s_start = bytes[r_end + 2] === 0 ? r_end + 3 : r_end + 2;
    const r = BigInt(__TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$ox$2f$_esm$2f$core$2f$Hex$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["fromBytes"](bytes.slice(r_start, r_end)));
    const s = BigInt(__TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$ox$2f$_esm$2f$core$2f$Hex$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["fromBytes"](bytes.slice(s_start)));
    return {
        r,
        s: s > __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$ox$2f$node_modules$2f40$noble$2f$curves$2f$esm$2f$p256$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["p256"].CURVE.n / 2n ? __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$ox$2f$node_modules$2f40$noble$2f$curves$2f$esm$2f$p256$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["p256"].CURVE.n - s : s
    };
}
async function parseCredentialPublicKey(response) {
    try {
        const publicKeyBuffer = response.getPublicKey();
        if (!publicKeyBuffer) throw new __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$ox$2f$_esm$2f$core$2f$WebAuthnP256$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CredentialCreationFailedError"]();
        // Converting `publicKeyBuffer` throws when credential is created by 1Password Firefox Add-on
        const publicKeyBytes = new Uint8Array(publicKeyBuffer);
        const cryptoKey = await crypto.subtle.importKey('spki', new Uint8Array(publicKeyBytes), {
            name: 'ECDSA',
        ...
        const findStart = (key)=>{
            ...
            for(let i = 0; i < data.length - coordinate.length; i++)if (coordinate.every((byte, j)=>data[i + j] === byte)) return i + coordinate.length;
            throw new __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$ox$2f$_esm$2f$core$2f$WebAuthnP256$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CredentialCreationFailedError"]();
        };
        const xStart = findStart(0x21);
        const yStart = findStart(0x22);
...
async function createCredential(options) {
    ...
    try {
        ...
        if (!credential) throw new CredentialCreationFailedError();
        const response = credential.response;
        const publicKey = await __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$ox$2f$_esm$2f$core$2f$internal$2f$webauthn$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["parseCredentialPublicKey"](response);
        return {
            id: credential.id,
            publicKey,
            raw: credential
...
function getAuthenticatorData() {
    ...
    return __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$ox$2f$_esm$2f$core$2f$Hex$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["concat"](rpIdHash, flag_bytes, signCount_bytes);
}
function getClientDataJSON(options) {
    const { challenge, crossOrigin = false, extraClientData, origin = window.location.origin } = options;
    return JSON.stringify({
...
function getCredentialCreationOptions(options) {
    ...
    return {
        publicKey: {
            ...
            rp,
            user: {
                id: (_user_id = user === null || user === void 0 ? void 0 : user.id) !== null && _user_id !== void 0 ? _user_id : __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$ox$2f$_esm$2f$core$2f$Hash$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["keccak256"](__TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$ox$2f$_esm$2f$core$2f$Bytes$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["fromString"](name), {
                    as: 'Bytes'
                }),
                name,
                displayName: (_user_displayName = user === null || user === void 0 ? void 0 : user.displayName) !== null && _user_displayName !== void 0 ? _user_displayName : name
...
async function sign(options) {
    ...
    try {
        ...
        const challengeIndex = clientDataJSON.indexOf('"challenge"');
        const typeIndex = clientDataJSON.indexOf('"type"');
        const signature = __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$ox$2f$_esm$2f$core$2f$internal$2f$webauthn$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["parseAsn1Signature"](new Uint8Array(response.signature));
        return {
            metadata: {
                authenticatorData: __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$ox$2f$_esm$2f$core$2f$Hex$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["fromBytes"](new Uint8Array(response.authenticatorData)),
                clientDataJSON,
                challengeIndex,
                typeIndex,
                userVerificationRequired: requestOptions.publicKey.userVerification === 'required'
...
function verify(options) {
    ...
    if (__TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$ox$2f$_esm$2f$core$2f$Hex$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["fromBytes"](__TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$ox$2f$_esm$2f$core$2f$Base64$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toBytes"](challenge_extracted)) !== challenge) return false;
...
class CredentialCreationFailedError extends __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$ox$2f$_esm$2f$core$2f$Errors$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["BaseError"] {
    constructor({ cause } = {}){
        super('Failed to create credential.', {
            cause
        });
...
class CredentialRequestFailedError extends __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$ox$2f$_esm$2f$core$2f$Errors$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["BaseError"] {
    constructor({ cause } = {}){
        super('Failed to request credential.', {
            cause
        });
...
function assert(envelope) {
    ...
    if (type === 'p256') {
        var _p256_signature, _p256_signature1;
        const p256 = envelope;
        const missing = [];
        if (typeof ((_p256_signature = p256.signature) === null || _p256_signature === void 0 ? void 0 : _p256_signature.r) !== 'bigint') missing.push('signature.r');
        if (typeof ((_p256_signature1 = p256.signature) === null || _p256_signature1 === void 0 ? void 0 : _p256_signature1.s) !== 'bigint') missing.push('signature.s');
    ...
    if (type === 'webAuthn') {
        var _webauthn_signature, _webauthn_signature1;
        const webauthn = envelope;
        const missing = [];
        if (typeof ((_webauthn_signature = webauthn.signature) === null || _webauthn_signature === void 0 ? void 0 : _webauthn_signature.r) !== 'bigint') missing.push('signature.r');
        if (typeof ((_webauthn_signature1 = webauthn.signature) === null || _webauthn_signature1 === void 0 ? void 0 : _webauthn_signature1.s) !== 'bigint') missing.push('signature.s');
...
function deserialize(value) {
    ...
    if (typeId === serializedP256Type) {
        ...
        if (dataSize !== 129) throw new InvalidSerializedError({
            reason: "Invalid P256 signature envelope size: expected 129 bytes, got ".concat(dataSize, " bytes"),
            serialized
        });
        return {
            publicKey: {
    ...
    if (typeId === serializedWebAuthnType) {
        ...
        if (dataSize < 128) throw new InvalidSerializedError({
            reason: "Invalid WebAuthn signature envelope size: expected at least 128 bytes, got ".concat(dataSize, " bytes"),
            serialized
        });
    ...
    throw new InvalidSerializedError({
        reason: "Unknown signature type identifier: ".concat(typeId, ". Expected ").concat(serializedP256Type, " (P256) or ").concat(serializedWebAuthnType, " (WebAuthn)"),
        serialized
    });
}
function from(value) {
...
function serialize(envelope) {
    ...
    if (type === 'keychain') {
        const keychain = envelope;
        return __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$ox$2f$_esm$2f$core$2f$Hex$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["concat"](serializedKeychainType, keychain.userAddress, serialize(keychain.inner), options.magic ? magicBytes : '0x');
    }
    throw new CoercionError({
        envelope
    });
...
function verify(signature, parameters) {
    ...
    throw new VerificationError('Unable to verify signature envelope of type "'.concat(envelope.type, '".'));
}
class CoercionError extends __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$ox$2f$_esm$2f$core$2f$Errors$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["BaseError"] {
    constructor({ envelope }){
        super("Unable to coerce value (`".concat(__TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$ox$2f$_esm$2f$core$2f$Json$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["stringify"](envelope), "`) to a valid signature envelope."));
        Object.defineProperty(this, "name", {
            enumerable: true,
            configurable: true,
            writable: true,
...
class MissingPropertiesError extends __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$ox$2f$_esm$2f$core$2f$Errors$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["BaseError"] {
    constructor({ envelope, missing, type }){
        super('Signature envelope of type "'.concat(type, '" is missing required properties: ').concat(missing.map((m)=>"`".concat(m, "`")).join(', '), ".\n\nProvided: ").concat(__TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$ox$2f$_esm$2f$core$2f$Json$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["stringify"](envelope)));
        Object.defineProperty(this, "name", {
            enumerable: true,
            configurable: true,
            writable: true,
...
class InvalidSerializedError extends __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$ox$2f$_esm$2f$core$2f$Errors$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["BaseError"] {
    constructor({ reason, serialized }){
        super("Unable to deserialize signature envelope: ".concat(reason), {
            metaMessages: [
...
function fromRpc(transaction) {
    ...
    var _transaction_gas;
    transaction_.gas = BigInt((_transaction_gas = transaction.gas) !== null && _transaction_gas !== void 0 ? _transaction_gas : 0n);
    var _transaction_nonce;
    transaction_.nonce = BigInt((_transaction_nonce = transaction.nonce) !== null && _transaction_nonce !== void 0 ? _transaction_nonce : 0n);
    transaction_.transactionIndex = transaction.transactionIndex ? Number(transaction.transactionIndex) : null;
    var _transaction_value;
    transaction_.value = BigInt((_transaction_value = transaction.value) !== null && _transaction_value !== void 0 ? _transaction_value : 0n);
    ...
    var _fromRpcType_transaction_type;
    if (transaction.type) transaction_.type = (_fromRpcType_transaction_type = fromRpcType[transaction.type]) !== null && _fromRpcType_transaction_type !== void 0 ? _fromRpcType_transaction_type : transaction.type;
...
function toRpc(transaction, _options) {
    ...
    var _transaction_gas;
    rpc.gas = __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$ox$2f$_esm$2f$core$2f$Hex$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["fromNumber"]((_transaction_gas = transaction.gas) !== null && _transaction_gas !== void 0 ? _transaction_gas : 0n);
    rpc.hash = transaction.hash;
    rpc.input = transaction.input;
    var _transaction_nonce;
    rpc.nonce = __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$ox$2f$_esm$2f$core$2f$Hex$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["fromNumber"]((_transaction_nonce = transaction.nonce) !== null && _transaction_nonce !== void 0 ? _transaction_nonce : 0n);
    ...
    var _toRpcType_transaction_type;
    rpc.type = (_toRpcType_transaction_type = toRpcType[transaction.type]) !== null && _toRpcType_transaction_type !== void 0 ? _toRpcType_transaction_type : transaction.type;
    var _transaction_value;
    rpc.value = __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$ox$2f$_esm$2f$core$2f$Hex$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["fromNumber"]((_transaction_value = transaction.value) !== null && _transaction_value !== void 0 ? _transaction_value : 0n);
...
function fromRpc(authorization) {
    ...
    return {
        ...
        limits: limits === null || limits === void 0 ? void 0 : limits.map((limit)=>({
                token: limit.token,
    ...
    const keyType = (()=>{
        switch(keyType_hex){
            ...
            case '0x02':
                return 'webAuthn';
            default:
                throw new Error("Invalid key type: ".concat(keyType_hex));
        }
    })();
    const args = {
        address: keyId,
        expiry: typeof expiry !== 'undefined' ? __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$ox$2f$_esm$2f$core$2f$Hex$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toNumber"](expiry) : undefined,
        type: keyType,
        ...chainId !== '0x' ? {
            chainId: __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$ox$2f$_esm$2f$core$2f$Hex$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toBigInt"](chainId)
        } : {},
        ...typeof expiry !== 'undefined' ? {
            expiry: __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$ox$2f$_esm$2f$core$2f$Hex$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toNumber"](expiry)
        } : {},
        ...typeof limits !== 'undefined' ? {
            limits: limits.map((param)=>{
                let [token, limit] = param;
                return {
                    token,
                    limit: BigInt(limit)
                };
...
function toRpc(authorization) {
    ...
    return {
        ...
        expiry: typeof expiry === 'number' ? __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$ox$2f$_esm$2f$core$2f$Hex$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["fromNumber"](expiry) : undefined,
        limits: limits === null || limits === void 0 ? void 0 : limits.map((param)=>{
            let { token, limit } = param;
            return {
                token,
    ...
    const type = (()=>{
        switch(authorization.type){
            ...
            case 'webAuthn':
                return '0x02';
            default:
                throw new Error("Invalid key type: ".concat(authorization.type));
        }
    })();
    var _limits_map;
    const authorizationTuple = [
        chainId === 0n ? '0x' : __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$ox$2f$_esm$2f$core$2f$Hex$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["fromNumber"](chainId),
        type,
        address,
        typeof expiry === 'number' ? __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$ox$2f$_esm$2f$core$2f$Hex$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["fromNumber"](expiry) : undefined,
        (_limits_map = limits === null || limits === void 0 ? void 0 : limits.map((limit)=>[
                limit.token,
                __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$ox$2f$_esm$2f$core$2f$Hex$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["fromNumber"](limit.limit)
            ])) !== null && _limits_map !== void 0 ? _limits_map : undefined
    ].filter(Boolean);
    return [
        authorizationTuple,
        ...signature ? [
...
function toRpc(transaction, _options) {
    ...
    if (transaction.feePayerSignature) {
        var _transaction_feePayerSignature;
        ...
        rpc.feePayerSignature.v = __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$ox$2f$_esm$2f$core$2f$Hex$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["fromNumber"](__TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$ox$2f$_esm$2f$core$2f$Signature$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["yParityToV"]((_transaction_feePayerSignature = transaction.feePayerSignature) === null || _transaction_feePayerSignature === void 0 ? void 0 : _transaction_feePayerSignature.yParity));
    }
...
function fromAddress(address) {
    ...
    return __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$ox$2f$_esm$2f$core$2f$Hex$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toBigInt"](__TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$ox$2f$_esm$2f$core$2f$Hex$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["slice"](address, tip20Prefix.length));
}
function toAddress(tokenId) {
    if (typeof tokenId === 'string') {
        __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$ox$2f$_esm$2f$core$2f$Address$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["assert"](tokenId);
        return tokenId;
    }
...
class InvalidStorageKeySizeError extends __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$ox$2f$_esm$2f$core$2f$Errors$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["BaseError"] {
    constructor({ storageKey }){
        super('Size for storage key "'.concat(storageKey, '" is invalid. Expected 32 bytes. Got ').concat(__TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$ox$2f$_esm$2f$core$2f$Hex$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["size"](storageKey), " bytes."));
        Object.defineProperty(this, "name", {
            enumerable: true,
            configurable: true,
            writable: true,
...
class FeeCapTooHighError extends __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$ox$2f$_esm$2f$core$2f$Errors$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["BaseError"] {
    constructor({ feeCap } = {}){
        super("The fee cap (`maxFeePerGas`/`maxPriorityFeePerGas`".concat(feeCap ? " = ".concat(__TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$ox$2f$_esm$2f$core$2f$Value$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["formatGwei"](feeCap), " gwei") : '', ") cannot be higher than the maximum allowed value (2^256-1)."));
        Object.defineProperty(this, "name", {
            enumerable: true,
            configurable: true,
            writable: true,
...
class GasPriceTooHighError extends __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$ox$2f$_esm$2f$core$2f$Errors$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["BaseError"] {
    constructor({ gasPrice } = {}){
        super("The gas price (`gasPrice`".concat(gasPrice ? " = ".concat(__TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$ox$2f$_esm$2f$core$2f$Value$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["formatGwei"](gasPrice), " gwei") : '', ") cannot be higher than the maximum allowed value (2^256-1)."));
        Object.defineProperty(this, "name", {
            enumerable: true,
            configurable: true,
            writable: true,
...
class TipAboveFeeCapError extends __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$ox$2f$_esm$2f$core$2f$Errors$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["BaseError"] {
    constructor({ maxPriorityFeePerGas, maxFeePerGas } = {}){
        super([
            "The provided tip (`maxPriorityFeePerGas`".concat(maxPriorityFeePerGas ? " = ".concat(__TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$ox$2f$_esm$2f$core$2f$Value$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["formatGwei"](maxPriorityFeePerGas), " gwei") : '', ") cannot be higher than the fee cap (`maxFeePerGas`").concat(maxFeePerGas ? " = ".concat(__TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$ox$2f$_esm$2f$core$2f$Value$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["formatGwei"](maxFeePerGas), " gwei") : '', ").")
        ].join('\n'));
        Object.defineProperty(this, "name", {
            enumerable: true,
            configurable: true,
...
function deserialize(serialized) {
    ...
    if ((accessList === null || accessList === void 0 ? void 0 : accessList.length) !== 0 && accessList !== '0x') transaction.accessList = __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$ox$2f$_esm$2f$core$2f$AccessList$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["fromTupleList"](accessList);
    if ((authorizationList === null || authorizationList === void 0 ? void 0 : authorizationList.length) !== 0 && authorizationList !== '0x') transaction.authorizationList = __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$ox$2f$_esm$2f$tempo$2f$AuthorizationTempo$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["fromTupleList"](authorizationList);
    if (feePayerSignatureOrSender !== '0x' && feePayerSignatureOrSender !== undefined) {
        if (feePayerSignatureOrSender === '0x00' || __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$ox$2f$_esm$2f$core$2f$Address$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["validate"](feePayerSignatureOrSender)) transaction.feePayerSignature = null;
...
function serialize(envelope) {
    ...
    const callsTupleList = calls.map((call)=>{
        var _call_to, _call_data;
        return [
            (_call_to = call.to) !== null && _call_to !== void 0 ? _call_to : '0x',
    ...
    const serialized = [
        ...
        typeof feeToken === 'bigint' || typeof feeToken === 'string' ? __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$ox$2f$_esm$2f$tempo$2f$TokenId$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toAddress"](feeToken) : '0x',
        feePayerSignatureOrSender,
...
class InvalidValidityWindowError extends __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$ox$2f$_esm$2f$core$2f$Errors$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["BaseError"] {
    constructor({ validBefore, validAfter }){
        super("validBefore (".concat(validBefore, ") must be greater than validAfter (").concat(validAfter, ")."));
        Object.defineProperty(this, "name", {
            enumerable: true,
            configurable: true,
            writable: true,
...
//# sourceMappingURL=9e883_2d60a44c._.js.map