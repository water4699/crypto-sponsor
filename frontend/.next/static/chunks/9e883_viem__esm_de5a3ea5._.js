...
function deserialize(serializedTransaction) {
    ...
    if (type === '0x76') {
        const from = __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$ox$2f$_esm$2f$core$2f$Hex$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["slice"](serializedTransaction, -6) === '0xfeefeefeefee' ? __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$ox$2f$_esm$2f$core$2f$Hex$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["slice"](serializedTransaction, -26, -6) : undefined;
        return {
...
async function serialize(transaction, signature) {
    ...
    if (!isTempo(transaction)) {
        ...
        if (signature && 'type' in signature) {
            const { r, s, yParity } = signature === null || signature === void 0 ? void 0 : signature.signature;
...
/** @internal */ function deserializeTempo(serializedTransaction) {
    ...
    return {
        ...tx,
        nonce: Number(nonce !== null && nonce !== void 0 ? nonce : 0n),
...
/** @internal */ async function serializeTempo(transaction, sig) {
    ...
    const transaction_ox = {
        ...rest,
        calls: ((_rest_calls = rest.calls) === null || _rest_calls === void 0 ? void 0 : _rest_calls.length) ? rest.calls : [
            {
    ...
    if (feePayer === true) {
        const serialized = __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$ox$2f$_esm$2f$tempo$2f$TxEnvelopeTempo$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__TxEnvelopeTempo$3e$__["TxEnvelopeTempo"].serialize(transaction_ox, {
        ...
        if (transaction.from && signature) return __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$ox$2f$_esm$2f$core$2f$Hex$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["concat"](serialized, transaction.from, '0xfeefeefeefee');
        return serialized;
    }
...
function formatTransaction(transaction) {
    ...
    return {
        ...
        feePayerSignature: feePayerSignature ? {
            ...
            v: BigInt((_feePayerSignature_v = feePayerSignature.v) !== null && _feePayerSignature_v !== void 0 ? _feePayerSignature_v : 27),
            yParity: feePayerSignature.yParity
        } : undefined,
        nonce: Number(nonce),
...
function formatTransactionRequest(r, action) {
    ...
    var _request_calls;
    if (action) request.calls = (_request_calls = request.calls) !== null && _request_calls !== void 0 ? _request_calls : [
        {
    ...
    const [keyType, keyData] = (()=>{
        const type = account && 'keyType' in account ? account.keyType : account === null || account === void 0 ? void 0 : account.source;
        if (!type) return [
            undefined,
            undefined
        ];
...
"[project]/frontend/node_modules/viem/_esm/tempo/internal/nonceKeyStore.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function getCacheKey(parameters) {
    return "".concat(parameters.address.toLowerCase(), "-").concat(parameters.chainId);
}
...
var __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$viem$2f$_esm$2f$tempo$2f$internal$2f$nonceKeyStore$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/frontend/node_modules/viem/_esm/tempo/internal/nonceKeyStore.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$viem$2f$_esm$2f$tempo$2f$Transaction$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/frontend/node_modules/viem/_esm/tempo/Transaction.js [app-client] (ecmascript) <locals>");
;
;
;
...
const chainConfig = {
    ...
    async prepareTransactionRequest (r) {
        ...
        request.nonceKey = (()=>{
            ...
            var _request_account_address;
            const address = (_request_account_address = (_request_account = request.account) === null || _request_account === void 0 ? void 0 : _request_account.address) !== null && _request_account_address !== void 0 ? _request_account_address : request.from;
            if (!address) return undefined;
            if (!request.chain) return undefined;
            const nonceKey = __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$viem$2f$_esm$2f$tempo$2f$internal$2f$nonceKeyStore$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getNonceKey"](__TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$viem$2f$_esm$2f$tempo$2f$internal$2f$nonceKeyStore$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["store"], {
                address,
        ...
        if (!request.feeToken && ((_request_chain = request.chain) === null || _request_chain === void 0 ? void 0 : _request_chain.feeToken)) request.feeToken = request.chain.feeToken;
        return request;
    },
    serializers: {
    ...
    async verifyHash (client, parameters) {
        ...
        if (typeof signature === 'string' && signature.endsWith(__TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$ox$2f$_esm$2f$tempo$2f$SignatureEnvelope$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["magicBytes"].slice(2))) {
            const envelope = __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$ox$2f$_esm$2f$tempo$2f$SignatureEnvelope$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["deserialize"](signature);
            if (envelope.type !== 'keychain') {
                ...
                code === '0xef01007702c00000000000000000000000000000000000') return __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$ox$2f$_esm$2f$tempo$2f$SignatureEnvelope$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["verify"](envelope, {
                    address,
                    payload: hash
                });
            }
...
//# sourceMappingURL=9e883_viem__esm_de5a3ea5._.js.map